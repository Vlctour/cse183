...
class Assignment(ProtoAssignment):
    ...
    def step5(self):
        ...
        # print("in step5, rows are")
        # for i in range(len(item_rows)):
        #     print(item_rows[i].find_element(By.CSS_SELECTOR, "td.item").text)
        item1 = item_rows[0].find_element(By.CSS_SELECTOR, "td.item").text
        # print("selecting", item1)
        ...
        # print("rows are, after checkbox")
        # for i in range(len(item_rows)):
        #     print(item_rows[i].find_element(By.CSS_SELECTOR, "td.item").text)
        # print("comparing:", item1, item_rows[1].find_element(By.CSS_SELECTOR, "td.item").text)
